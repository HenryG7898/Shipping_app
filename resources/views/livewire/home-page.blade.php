    ...
    <div class="container mx-auto px-8 py-3">
        ...
        <hr class="my-6 border-gray-300 w-full">
            <div class="mt-2 flex justify-between">
                <h3 class="text-gray-700 text-2xl font-medium">Hi Rojae</h3>
                <p>LogiFreight 136020 KIN</p>
            </div>
        <div class="mt-4">
            <div class="flex grid-cols-4 -mx-2">
                ...
                <div class="w-full mt-6 px-2 sm:w-1/2 xl:w-1/3 sm:mt-0">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                ...
                <div class="w-full mt-6 px-4 sm:w-1/2 xl:w-2/6 xl:mt-0">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                ...
                <div class="w-full mt-6 px-2 sm:w-1/2 xl:w-1/3 xl:mt-0">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                        <div class="p-3 rounded-full bg-pink-600 bg-opacity-75">
                            <svg class="h-8 w-8 text-white" viewBox="0 0 28 28" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
